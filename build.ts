...
for (const name of ["boot/agent-index", "boot/config", "boot/identity", "boot/newspaper-env", "boot/prompt", "boot/main", "boot/process", "boot/probe", "boot/probe-fixture", "boot/mcp-bridge", "plugin/index", "plugin/group-listen", "plugin/setup-gate", "plugin/transport"]) {
